...
import { User, Phone, FileText, Calendar, Clock, Stethoscope, Receipt, ArrowLeft, CreditCard } from "lucide-react"
                    ...
                    >
                      ...
                      <td className="p-4 text-center">
                        <Button asChild variant="outline" size="sm" className="medical-button border-blue-200 text-blue-700 hover:bg-blue-50">
                          <Link href={`/dashboard/invoices/${i.id}`} className="flex items-center gap-2">
